...
import spatialkit as cvu
from spatialkit import markers as marker
from spatialkit import FiducialMarkerType
from spatialkit.common.exceptions import InvalidMarkerTypeError, IncompatibleTypeError
import cv2 as cv
...
class TestInitDetector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ds_image = cvu.imgproc.transition_camera_view(self.equi_image,
                                                              self.equi_cam,
                                                              self.ds_cam)
        self.pinhole_image = cvu.imgproc.transition_camera_view(self.equi_image,
                                                                    self.equi_cam,
                                                                    self.pinhole_cam)
    ...
    @unittest.skip("Skipping AprilTag tests due to segfault issue")
