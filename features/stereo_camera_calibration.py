...
if __name__ == "__main__":
    ...
    parser.add_argument('--camera_index_left', type=int,  help='Index of the left camera')
    parser.add_argument('--camera_index_right', type=int, help='Index of the right camera')
