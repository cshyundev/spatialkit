...
Description:
This module defines a hierarchical exception structure for the cv_utils library.
...
Usage:
    >>> from cv_utils.exceptions import InvalidDimensionError, MathError
    >>> 
    ...
    >>> try:
    ...     # any cv_utils operation
    ... except CVUtilsError as e:
    ...     print(f"cv_utils error: {e}")
"""
...
class CVUtilsError(Exception):
    """
    Base exception for all cv_utils library errors.
    
    This is the root exception from which all other cv_utils exceptions inherit.
    It allows users to catch any error originating from the cv_utils library.
    """
    pass
...
# =============================================================================
# Multi-View Stereo (MVS) Exceptions
# =============================================================================

class MVSError(CVUtilsError):
    """
    Base exception for multi-view stereo operations.
    
    Raised when MVS dataset operations, 3D reconstruction,
    or related computations fail.
    """
    pass


class DatasetError(MVSError):
    """
    Exception raised for MVS dataset-related failures.
    
    Examples:
        - Invalid dataset structure
        - Missing dataset files
        - Corrupted dataset data
    """
    pass


class ReconstructionError(MVSError):
    """
    Exception raised for 3D reconstruction failures.
    
    Examples:
        - Point cloud generation failures
        - Mesh reconstruction errors
        - Insufficient view overlap
    """
    pass
...
def is_cv_utils_error(exception: Exception) -> bool:
    """
    Check if an exception is a cv_utils library exception.
    
    Args:
        exception (Exception): Exception to check.
        
    Returns:
        bool: True if exception is from cv_utils, False otherwise.
    """
